    ...
    <div class='offcanvas-menu-wrapper'>
      ...
      <div class='offcanvas__option'>
        <ul>
          ...
          <li>Sign in <span class='arrow_carrot-down'></span>
            <ul>
              <li>Sign in</li>
              <li>Sign up</li>
            </ul>
              ...
              <div class='header__top__inner'>
                ...
                <div class='header__top__right'>
                  ...
                  <div class='header__top__right__cart'>
                    <a class='dropdown' href='#'><img src='/img/icon/cart.png' alt=''> <span>0</span></a>
                    <div class='cart__price'>Cart: <span>$0.00</span></div>
                  </div>
                </div>
              </div>
          ...
          <div class='col-lg-3 col-md-6 col-sm-6'>
            <div class='product__item'>
              ...
              <div class='product__item__text'>
                ...
                <div class='cart_add' id='cart_add'>
  ...
  head() {
    return {
      link: [
        ...
        { rel: 'stylesheet', href: '/css/barfiller.css' },
      ...
      script: [
        ...
        { hid: 'stripe', src: '/js/owl.carousel.min.js', defer: true },

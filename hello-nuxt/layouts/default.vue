<template>
  <div class='mod-bg-1 mod-nav-link '>
    ...
    <div class='page-wrapper'>
      <div class='page-inner'>
          ...
          <nav id='js-primary-nav' class='primary-nav' role='navigation'>
            <div class='nav-filter'>
              <div class='position-relative'>
                <input id='nav_filter_input' class='form-control' placeholder='Filter menu' tabindex='0' type='text'>
        ...
        <div class='page-content-wrapper'>
          ...
          <header class='page-header' role='banner'>
            ...
            <div class='search'>
              <form class='app-forms hidden-xs-down' role='search' action='page_search.html' autocomplete='off'>
                <input id='search-field' class='form-control' placeholder='Search for anything' tabindex='1'
                       type='text'>
              ...
              <div>
                ...
                <div class="dropdown-menu dropdown-menu-animated w-auto h-auto">
                  ...
                  <div class="custom-scroll h-100">
                    ...
                    </ul><div class="slimScrollBar" style="background: rgba(0, 0, 0, 0.6); width: 4px; position: absolute; top: 0; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 4px; height: 237.798px;"></div><div class="slimScrollRail" style="width: 4px; height: 100%; position: absolute; top: 0; display: none; border-radius: 7px; background: rgb(250, 250, 250); opacity: 0.2; z-index: 90; right: 4px;"></div></div>
                  </div>
                </div>
              </div>
              <!-- app message -->
                  ...
                  <div class="tab-content tab-notification">
                    ...
                    <div class="tab-pane" id="tab-messages" role="tabpanel">
                      <div class="custom-scroll h-100">
                        ...
                        </ul><div class="slimScrollBar" style="background: rgba(0, 0, 0, 0.6); width: 4px; position: absolute; top: 0; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 4px;"></div><div class="slimScrollRail" style="width: 4px; height: 100%; position: absolute; top: 0; display: none; border-radius: 7px; background: rgb(250, 250, 250); opacity: 0.2; z-index: 90; right: 4px;"></div></div>
                      </div>
                    </div>
                          ...
                          <table class="table table-bordered table-calendar m-0 w-100 h-100 border-0">
                            <tbody><tr>
                              <th colspan="7" class="pt-3 pb-2 pl-3 pr-3 text-center">
                                <div class="js-get-date h5 mb-2">Tuesday, October 26, 2021</div>
                              </th>
                            </tr>
          ...
          <!-- END Page Footer -->
          <!-- BEGIN Shortcuts -->
          <div id='modal-shortcut' aria-hidden='true' aria-labelledby='modal-shortcut' class='modal fade modal-backdrop-transparent'
    ...
    <nav class='shortcut-menu d-none d-sm-block'>
      <input id='menu_open' class='menu-open' name='menu-open' type='checkbox' />
            ...
            <div class='settings-panel'>
              ...
              <div class='expanded theme-colors pl-5 pr-3'>
                <ul class='m-0'>
                  ...
                  <li>
                    <a id='myapp-15' data-action='theme-update' data-original-title='Hoki' data-placement='top'
                       data-theme='css/themes/cust-theme-15.css' data-themesave data-toggle='tooltip' href='#'
                       title='Hoki'></a>
                  </li>
                </ul>
              </div>
                ...
                <div class='row no-gutters'>
                  <div class='col-4 pr-2 text-center'>
                    <div id='skin-default' data-action='toggle-replace' data-replaceclass='mod-skin-light mod-skin-dark'
                         ...
                         data-original-title='Default Mode' style='height: 80'>
                  ...
                  <div class='col-4 px-1 text-center'>
                    <div id='skin-light' data-action='toggle-replace' data-replaceclass='mod-skin-dark'
                         ...
                         data-original-title='Light Mode' style='height: 80'>
                  ...
                  <div class='col-4 pl-2 text-center'>
                    <div id='skin-dark' data-action='toggle-replace' data-replaceclass='mod-skin-light'
                         ...
                         data-original-title='Dark Mode' style='height: 80'>
  ...
  head() {
    return {
      link: [
        ...
        { rel: 'stylesheet', href: '/css/datagrid/datatables/datatables.bundle.css' }
      ],
      script: [
        { hid: 'stripe', src: '/js/datagrid/datatables/datatables.bundle.js', defer: true },
        { hid: 'stripe', src: '/js/vendors.bundle.js', defer: true },
        { hid: 'stripe', src: '/js/app.bundle.js', defer: true }
      ]
    }
  }
}
